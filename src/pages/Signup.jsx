        ...
        <div className="grid min-h-screen grid-cols-1 lg:grid-cols-2">
          ...
          <div className="flex items-center justify-center px-6 py-10 lg:px-16">
            <div className="w-full max-w-xl">
              <Link
                to="/"
                className="mb-8 inline-block text-sm text-slate-500 transition hover:text-slate-700"
              >
                ← Retour au site
              </Link>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="h-14 w-full rounded-xl bg-[#3433a7] text-sm font-semibold text-white transition hover:bg-[#2b2a8d] disabled:cursor-not-allowed disabled:opacity-70"
                >
              ...
              <p className="mt-5 text-center text-sm text-slate-500">
                ...
                <Link
                  to="/login"
                  className="font-semibold text-[#3433a7] hover:underline"
                >
                  Se connecter
                </Link>
              </p>
              ...
              <p className="mt-6 text-center text-xs leading-5 text-slate-400">
                Tous les champs sont requis. En cliquant sur Continuer, vous
                acceptez nos CGU et notre Politique de Confidentialité.
              </p>
            </div>
          </div>
            ...
            <div className="relative z-10 w-full max-w-lg px-8">
              <div className="relative">
                ...
                <div className="relative z-10 rounded-2xl bg-white p-8 shadow-xl">
                  <div className="mb-4 text-6xl leading-none text-slate-200">
                    “
                  </div>

                  <p className="text-3xl font-semibold leading-tight text-[#2a2a2a]">
                    J&apos;ai longtemps cherché un moyen de m&apos;impliquer sans
                    tomber dans la politique politicienne.
                    <span className="text-[#3433a7]"> Les Voies </span>
                    m&apos;apporte enfin des analyses concrètes et des solutions
                    qui s&apos;inspirent de ce qui marche ailleurs.
                  </p>
      ...
      {showQuizModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4">
          <div className="w-full max-w-md rounded-3xl bg-white p-6 shadow-2xl">
            <h2 className="mb-3 text-2xl font-bold text-[#3433a7]">
              Bienvenue {createdUser?.firstName || ""} 👋
            </h2>

            <p className="mb-6 text-sm leading-6 text-slate-600">
              Ton inscription est validée. Tu peux maintenant commencer le quiz
              pour découvrir le sport qui te correspond.
            </p>

            <div className="flex flex-col gap-3">
              <button
                onClick={handleStartQuiz}
                className="h-12 w-full rounded-full bg-[#f4a631] text-sm font-semibold text-black transition hover:opacity-90"
              >
                Commencer le quiz
              </button>
              ...
              <button
                ...
                className="h-12 w-full rounded-full border border-slate-300 text-sm font-semibold text-slate-700 transition hover:bg-slate-50"
              >
                Plus tard
              </button>
            </div>
